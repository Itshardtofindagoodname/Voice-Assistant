...
if __name__ == '__main__':
	...
	while True:
		...
		if 'wikipedia' in query:
			...
			speak("I have been created by Debarjun.")
			...
			speak("I am your virtual assistant created by Debarjun")

		elif 'reason for you' in query:
			speak("I was created as a Minor project by Debarjun ")
		...
		# this is literally the most asked question to google Assistant
